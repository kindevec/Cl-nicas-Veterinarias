...
export function AppointmentScheduler({ initialService, onAppointmentCreated }: AppointmentSchedulerProps) {
  ...
  return (
    <section id="agendar" className="py-12 sm:py-16 bg-[#FAFBF7] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-slate-600 max-w-xl mx-auto">
            Comunícate con nuestro equipo médico para consultas, citas o urgencias. Estamos disponibles las 24 horas.
          </p>
        </motion.div>

        {/* Clean 2-Column Grid (AOVET Style) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          
          {/* LEFT COLUMN: Contacto, Redes Sociales & Mapa de Google (5 cols) */}
          <motion.div 
          ...
          {/* RIGHT COLUMN: Formulario Sencillo y Directo (7 cols) */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: '-40px' }}
