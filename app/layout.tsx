...
export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    <html lang="es" className="scroll-smooth">
      ...
      <body className="font-sans bg-[#F8FAFC] text-slate-800 antialiased selection:bg-emerald-100 selection:text-emerald-900 min-h-screen" suppressHydrationWarning>
        {children}
      </body>
    </html>
  );
